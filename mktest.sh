...
function setup_jdk() {
    ...
    wget -nv https://ci.adoptopenjdk.net/view/ev3dev/job/openjdk9_build_ev3_linux/lastSuccessfulBuild/artifact/build/jdk-ev3.tar.gz
...
function run_tests() {
    ...
    ./get.sh   -t /opt/jdktest/openjdk-tests   -p   linux-arm   -v    openjdk9
    cd TestConfig
    ...
    #ls /opt/jdktest/jvmtest/openjdk_regression/report/test_output_*
    pwd
    ls
}
